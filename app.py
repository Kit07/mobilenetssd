...
lineaccesstoken = 'ylYUbRmzVbj4wYJoENImJX5uI6CEuZz2hO+g0Pp2UFUXmEPx8B6V9wGYKwc9FqE1Y3BlNBFBgH67INbHKwoKDXLVssAafxO4D1aFn7MKqIRmeUE7Rslb2KoWBMLd9X4i87b381rJAc2l57XDO3zEEwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี"
          replyObj = TextSendMessage(text="เออหวัดดีหนุ่ม")
          line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "หิวข้าวป่ะ"  
          replyObj = TextSendMessage(text="หิวดิยังไม่ได้กินอะไรเลย")
          line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "สนใจดูหนังกันมั๊ย"
          replyObj = TextSendMessage(text="สนใจคนชวนมากกว่า")
          line_bot_api.reply_message(rtoken, replyObj)
        else :
